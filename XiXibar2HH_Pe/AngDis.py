...
#  Print the values of class instance parameters:
    ...
    # 
        ...
        pdf = multi_dot([dLb0_A[:,0], dC_A, dX_A, dXb_A, dL0_A[:,0]])/V

        # ---------------------------------   Analytic derivatives calculation      
        
        dapsi = multi_dot([dL0_A[:,0], dX_A, dC_aP, dXb_A, dLb0_A[:,0]])/V + pdf*V/V1
        dppsi = multi_dot([dL0_A[:,0], dX_A, dC_pP, dXb_A, dLb0_A[:,0]])/V
        dpe = multi_dot([dL0_A[:,0], dX_A, dC_Pe, dXb_A, dLb0_A[:,0]])/V
        dal = multi_dot([dL0_aM[:,0], dX_A, dC_A, dXb_A, dLb0_A[:,0]])/V
        dax = multi_dot([dL0_A[:,0], dX_aM, dC_A, dXb_A, dLb0_A[:,0]])/V
        dpx = multi_dot([dL0_A[:,0], dX_pM, dC_A, dXb_A, dLb0_A[:,0]])/V
        dalb = multi_dot([dL0_A[:,0], dX_A, dC_A, dXb_A, dLb0_aM[:,0]])/V
        daxb = multi_dot([dL0_A[:,0], dX_A, dC_A, dXb_aM, dLb0_A[:,0]])/V
        dpxb = multi_dot([dL0_A[:,0], dX_A, dC_A, dXb_pM, dLb0_A[:,0]])/V
